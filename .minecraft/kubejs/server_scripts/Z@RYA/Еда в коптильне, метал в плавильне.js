onEvent('recipes', e => {
	...
	e.smelting('5x minecraft:iron_nugget', 'create:crushed_raw_iron').xp(0.1)
	...
	e.blasting('minecraft:iron_ingot', 'create:crushed_raw_iron').xp(0.1)
	...
	e.smelting('5x minecraft:gold_nugget', 'create:crushed_raw_gold').xp(0.1)
	...
	e.blasting('minecraft:gold_ingot', 'create:crushed_raw_gold').xp(0.1)
	...
	e.smelting('5x create:copper_nugget', 'create:crushed_raw_copper').xp(0.1)
	...
	e.blasting('minecraft:copper_ingot', 'create:crushed_raw_copper').xp(0.1)
	...
	e.smelting('5x create:zinc_nugget', 'create:crushed_raw_zinc').xp(0.1)
