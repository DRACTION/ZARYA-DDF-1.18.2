let za_newRepair = {
  ...
  durability: {
    div: 4,  // ПрибавкаКПрочности = (МаксПрочность - ТекПрочность) / div
  ...
  repair: {
    ...
    max: 98.00, // Максимальный шанс
    step: 0.20  // Шаг, с которым шанс растёт до максимума
  },
  ...
  critFail: {
    ...
    min: 0.00,  // Минимальный шанс
    step: 0.50  // Шаг, с которым шанс уменьшается до минимума
  },
