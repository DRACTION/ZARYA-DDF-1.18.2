...
4. Делаем первоначальную настройку:
    1. Выбираем язык. Например русский. Нажимаем `Далее >`
    2. Выбираем версию Java по умолчанию. Нажмите ту строчку, где в версии есть `17`, и в пути написано `/Eclipse Adoptium/`
    3. Указываем количество выделяемой оперативной памяти. **Не ставьте больше, чем у вас есть!**
